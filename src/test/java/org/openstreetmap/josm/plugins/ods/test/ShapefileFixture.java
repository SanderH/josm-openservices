 ...
 */
public class ShapefileFixture {

    /**
     * Returns a new test fixture initialized to "unit" home.
     * @return A new test fixture for unit tests
     */
    static public ShapefileFixture createUnitTestFixture() {
        return new ShapefileFixture("test/config/unit-josm.home");
    }
     ...
     */
    static public ShapefileFixture createFunctionalTestFixture() {
        return new ShapefileFixture("test/config/functional-josm.home");
    }
     ...
     */
    static public ShapefileFixture createPerformanceTestFixture() {
        return new ShapefileFixture("test/config/performance-josm.home");
    }
     ...
     */
    public ShapefileFixture(String josmHome) {
