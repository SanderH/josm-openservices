...
/**
 * Implementation of MetaDataLoader that reads configuration data from a HTML or
 * XML page using JSoup.
 * 
...
public class HttpMetaDataLoader implements MetaDataLoader {
     ...
     * 
     * @param url
     *            The url pointing to the desired HTML page
     * @param attributes
     *            The attributeName to cssQuery mapping
     ...
     *            The url pointing to the desired HTML page
     * @param method
     *            The Http method (GET and POST) are supported
     * @param data
     *            The data for the POST request, or null for GET requests.
     * @throws ConfigurationException
     */
    public HttpMetaDataLoader(String url, String method,
        ...
        try {
            ...
            if (method.equals("GET")) {
                ...
                throw new MetaDataException(
                        "Unsupported HTML access method: " + method);
            }
            ...
            try {
                theUrl = new URL(url);
                throw new MetaDataException(
                        "The connection to the webserver at " + theUrl.getHost()
                                + " failed. Please try again later.",
                        e);
            } catch (MalformedURLException e1) {
                throw new MetaDataException("The URL " + url
                        + " is malformed. This is probably a configuration error."
