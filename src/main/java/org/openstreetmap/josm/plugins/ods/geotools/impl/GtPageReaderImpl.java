 ...
 *
 */
public class GtPageReaderImpl implements GtPageReader {
    private SimpleFeatureSource featureSource;
    
    public GtPageReaderImpl(SimpleFeatureSource featureSource) {
        super();
        this.featureSource = featureSource;
    }

    @Override
    public DefaultFeatureCollection read(Query query, ProgressListener progressListener) throws IOException {
