...
//            10000000);
     ...
     */
    public static Long getSrid(CoordinateReferenceSystem crs) {
        return Long.valueOf(getIdentifier(crs).getCode());
    }
     ...
     * org.openstreetmap.josm.plugins.ods.crs.CRSUtil#getCrs
     * (java.lang.String)
     * TODO Replace on-the-fly creation of CoordinateReference systems with pre-registration.
     * Drop this in favour of pre-registration.
     */
